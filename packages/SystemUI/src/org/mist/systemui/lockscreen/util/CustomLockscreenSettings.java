...
public class CustomLockscreenSettings {
    ...
    private static final String PROP_ENABLED = "persist.mist.customlockscreen.enable";
    private static final String PROP_TYPE = "persist.mist.customlockscreen.type";
    private static final String PROP_COLOR = "persist.mist.customlockscreen.color";
    private static final String PROP_HOUR_COLOR = "persist.mist.customlockscreen.hour.color";
    private static final String PROP_MINUTE_COLOR = "persist.mist.customlockscreen.minute.color";
